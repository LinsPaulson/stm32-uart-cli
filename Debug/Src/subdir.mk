...
Src/%.o Src/%.su Src/%.cyclo: ../Src/%.c Src/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m0 -std=gnu11 -g3 -DDEBUG -DSTM32F070xB -DSTM32F070RBTx -DSTM32 -DSTM32F0 -DNUCLEO_F070RB -DSTM32F070xB -c -I../Inc -I"C:/Users/user/STM32CubeIDE/workspace_1.19.0/basic-03-uart-serial-command-interface/chip_headers/CMSIS/Device/ST/STM32F0xx/Include" -I"C:/Users/user/STM32CubeIDE/workspace_1.19.0/basic-03-uart-serial-command-interface/chip_headers/CMSIS/Include" -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -fcyclomatic-complexity -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@"
